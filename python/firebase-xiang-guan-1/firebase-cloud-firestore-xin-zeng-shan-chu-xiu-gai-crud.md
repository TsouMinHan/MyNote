---
description: >-
  Firebase 有很多好用的功能，其中之一就是資料庫，資料庫又分成Cloud Firestore 和 Real Time
  Database，各有各的優缺點，我主要是用Cloud Firestore，目前使用下來我覺得非常的方便，接下來會介紹些我使用過的指令。
---

# Firebase Cloud Firestore 新增刪除修改（CRUD）
...
進入Firebase網頁，登入Google帳號，選擇新增專案。 建立好專案之後到設定頁面，選擇服務帳戶，點選產生新的私密金鑰\(這個檔案很重要，不要放在開放的伺服器上或者給別人\)。
...
1. \[check if a Firebase App is already initialized in python

   \]\([https://stackoverflow.com/questions/44293241/check-if-a-firebase-app-is-already-initialized-in-python](https://stackoverflow.com/questions/44293241/check-if-a-firebase-app-is-already-initialized-in-python)\)
